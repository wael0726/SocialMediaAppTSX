        ...
        <div className="border max-w-3xl w-full">
          ...
          <div className="p-8 pb-4 border-b">
            <div className="flex flex-row items-center pb-4">
              ...
              <div>
                <div className="text-xl ml-3">{userInfo.displayName || "Guest_user"}</div>
                <div className="text-sm ml-3 text-gray-600">{user?.email || ""}</div>
                <p className="text-gray-600 text-sm mt-2">{userInfo.userBio}</p>
                <Button onClick={editProfile} className="mt-4">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {data.length > 0 ? renderPosts() : <div>...Loading</div>}
            </div>
          </div>
        </div>
      </div>
